...
{
    int orient_sign = orient3d(ax, ay, az,
                               bx, by, bz,
                               cx, cy, cz,
                               dx, dy, dz);
    if (orient_sign == 0) return 0;
                            ...
                            double alpha)
{
    ...
    if (a_nx >= a_ny && a_nx >= a_nz)
        orient_sign = orient3d(ax,ay,az, bx,by,bz, cx,cy,cz, ax+1,ay,az);
    else if (a_ny >= a_nz)
        orient_sign = orient3d(ax,ay,az, bx,by,bz, cx,cy,cz, ax,ay+1,az);
    else
        orient_sign = orient3d(ax,ay,az, bx,by,bz, cx,cy,cz, ax,ay,az+1);
...
extern "C" int orthow_n3_k4(double ax, double ay, double az, double wa,
                            ...
                            double alpha)
{
    int orient_sign = orient3d(ax,ay,az, bx,by,bz, cx,cy,cz, dx,dy,dz);
    if (orient_sign == 0) return 0;
