...
// ---------------------------------------------------------------------------
// lp2_feasible_T0_T1_S  -- orient_sign(TRI0, TRI1, seed_i)
// sign(|ti-A|^2 - |s-A|^2)
// Inputs: A(_1-_3), s(_4-_6), ti(_7-_9)
// ---------------------------------------------------------------------------
namespace lp2_feasible_T0_T1_S_impl {
...
extern "C" int lp2_feasible_T0_T1_S(double Ax, double Ay, double Az,
                                 double sx, double sy, double sz,
                                 double tix, double tiy, double tiz)
{
    return lp2_feasible_T0_T1_S_impl::pred{}.apply(Ax, Ay, Az, sx, sy, sz, tix, tiy, tiz);
}


// ---------------------------------------------------------------------------
// lp2_feasible_T1_T2_S  -- orient_sign(TRI1, TRI2, seed_i)
// sign(|ti-B|^2 - |s-B|^2)
// Inputs: B(_1-_3), s(_4-_6), ti(_7-_9)
// ---------------------------------------------------------------------------
namespace lp2_feasible_T1_T2_S_impl {
...
extern "C" int lp2_feasible_T1_T2_S(double Bx, double By, double Bz,
                                 double sx, double sy, double sz,
                                 double tix, double tiy, double tiz)
{
    return lp2_feasible_T1_T2_S_impl::pred{}.apply(Bx, By, Bz, sx, sy, sz, tix, tiy, tiz);
}


// ---------------------------------------------------------------------------
// lp2_feasible_T0_T2_S  -- orient_sign(TRI0, TRI2, seed_i)
// sign(|ti-C|^2 - |s-C|^2)
// Inputs: C(_1-_3), s(_4-_6), ti(_7-_9)
// ---------------------------------------------------------------------------
namespace lp2_feasible_T0_T2_S_impl {
...
extern "C" int lp2_feasible_T0_T2_S(double Cx, double Cy, double Cz,
                                 double sx, double sy, double sz,
                                 double tix, double tiy, double tiz)
{
    return lp2_feasible_T0_T2_S_impl::pred{}.apply(Cx, Cy, Cz, sx, sy, sz, tix, tiy, tiz);
}
...
extern "C" int lp2_D_T0_S(double Ax, double Ay, double Az,
                          double Cx, double Cy, double Cz,
                          double sx, double sy, double sz,
                          double tix, double tiy, double tiz)
{
    return lp2_D_T0_S_impl::pred{}.apply(Ax, Ay, Az, Cx, Cy, Cz, sx, sy, sz, tix, tiy, tiz);
}
...
extern "C" int lp2_D_T1_S(double Ax, double Ay, double Az,
                          double Bx, double By, double Bz,
                          double sx, double sy, double sz,
                          double tix, double tiy, double tiz)
{
    return lp2_D_T1_S_impl::pred{}.apply(Ax, Ay, Az, Bx, By, Bz, sx, sy, sz, tix, tiy, tiz);
}
...
extern "C" int lp2_D_T2_S(double Bx, double By, double Bz,
                          double Cx, double Cy, double Cz,
                          double sx, double sy, double sz,
                          double tix, double tiy, double tiz)
{
    return lp2_D_T2_S_impl::pred{}.apply(Bx, By, Bz, Cx, Cy, Cz, sx, sy, sz, tix, tiy, tiz);
}
...
extern "C" int lp2_det2(double Ax, double Ay, double Az,
                        double Bx, double By, double Bz,
                        double Cx, double Cy, double Cz,
                        double sx, double sy, double sz,
...
{
    return lp2_det2_impl::pred{}.apply(Ax, Ay, Az, Bx, By, Bz, Cx, Cy, Cz,
                                      sx, sy, sz, tjx, tjy, tjz, tkx, tky, tkz);
}


// ---------------------------------------------------------------------------
// lp2_feasible_T0_S_S  -- orient_sign(TRI0, seed_j, seed_l)
...
// ---------------------------------------------------------------------------
namespace lp2_feasible_T0_S_S_factor1_impl {
    constexpr auto Ax  = grp::_1;
    constexpr auto Ay  = grp::_2;
    constexpr auto Az  = grp::_3;
    // _4 _5 _6 = B, unused
...
namespace lp2_feasible_T0_S_S_factor2_impl {
    constexpr auto Ax  = grp::_1;
    constexpr auto Ay  = grp::_2;
    constexpr auto Az  = grp::_3;
    // _4 _5 _6 = B, unused
...
extern "C" int lp2_feasible_T0_S_S(double Ax, double Ay, double Az,
                                double Bx, double By, double Bz,
                                double Cx, double Cy, double Cz,
                                double sx, double sy, double sz,
                                double tjx, double tjy, double tjz,
...
{
    return lp2_feasible_T0_S_S_factor1_impl::pred{}.apply(Ax,Ay,Az, Bx,By,Bz, Cx,Cy,Cz,
                                                       sx,sy,sz, tjx,tjy,tjz, tlx,tly,tlz)
         * lp2_feasible_T0_S_S_factor2_impl::pred{}.apply(Ax,Ay,Az, Bx,By,Bz, Cx,Cy,Cz,
                                                       sx,sy,sz, tjx,tjy,tjz, tlx,tly,tlz);
}


// ---------------------------------------------------------------------------
// lp2_feasible_T1_S_S  -- orient_sign(TRI1, seed_j, seed_l)
...
// ---------------------------------------------------------------------------
namespace lp2_feasible_T1_S_S_factor1_impl {
    constexpr auto Ax  = grp::_1;
    constexpr auto Ay  = grp::_2;
    constexpr auto Az  = grp::_3;
    constexpr auto Bx  = grp::_4;
...
namespace lp2_feasible_T1_S_S_factor2_impl {
    constexpr auto Ax  = grp::_1;
    constexpr auto Ay  = grp::_2;
    constexpr auto Az  = grp::_3;
    constexpr auto Bx  = grp::_4;
...
extern "C" int lp2_feasible_T1_S_S(double Ax, double Ay, double Az,
                                double Bx, double By, double Bz,
                                double Cx, double Cy, double Cz,
                                double sx, double sy, double sz,
                                double tjx, double tjy, double tjz,
                                double tlx, double tly, double tlz)
{
    return lp2_feasible_T1_S_S_factor1_impl::pred{}.apply(Ax,Ay,Az, Bx,By,Bz, Cx,Cy,Cz,
                                                       sx,sy,sz, tjx,tjy,tjz, tlx,tly,tlz)
         * lp2_feasible_T1_S_S_factor2_impl::pred{}.apply(Ax,Ay,Az, Bx,By,Bz, Cx,Cy,Cz,
                                                       sx,sy,sz, tjx,tjy,tjz, tlx,tly,tlz);
}


// ---------------------------------------------------------------------------
// lp2_feasible_T2_S_S  -- orient_sign(TRI2, seed_j, seed_l)
...
// ---------------------------------------------------------------------------
namespace lp2_feasible_T2_S_S_factor1_impl {
    constexpr auto Ax  = grp::_1;
    constexpr auto Ay  = grp::_2;
    constexpr auto Az  = grp::_3;
    constexpr auto Bx  = grp::_4;
...
namespace lp2_feasible_T2_S_S_factor2_impl {
    constexpr auto Ax  = grp::_1;
    constexpr auto Ay  = grp::_2;
    constexpr auto Az  = grp::_3;
    constexpr auto Bx  = grp::_4;
...
extern "C" int lp2_feasible_T2_S_S(double Ax, double Ay, double Az,
                                double Bx, double By, double Bz,
                                double Cx, double Cy, double Cz,
                                double sx, double sy, double sz,
                                double tjx, double tjy, double tjz,
                                double tlx, double tly, double tlz)
{
    return lp2_feasible_T2_S_S_factor1_impl::pred{}.apply(Ax,Ay,Az, Bx,By,Bz, Cx,Cy,Cz,
                                                       sx,sy,sz, tjx,tjy,tjz, tlx,tly,tlz)
         * lp2_feasible_T2_S_S_factor2_impl::pred{}.apply(Ax,Ay,Az, Bx,By,Bz, Cx,Cy,Cz,
                                                       sx,sy,sz, tjx,tjy,tjz, tlx,tly,tlz);
}
...
extern "C" int lp2_det3(double Ax, double Ay, double Az,
                        double Bx, double By, double Bz,
                        double Cx, double Cy, double Cz,
                        double sx, double sy, double sz,
                        double tjx, double tjy, double tjz,
                        ...
                        double tlx, double tly, double tlz)
{
    return lp2_det3_impl::pred{}.apply(Ax, Ay, Az, Bx, By, Bz, Cx, Cy, Cz,
                                      sx, sy, sz, tjx, tjy, tjz, tkx, tky, tkz,
                                      tlx, tly, tlz);
}
...
// ---------------------------------------------------------------------------
// lp2_feasible_T0_S_T2  -- orient_sign(TRI0, seed_j, TRI2)
// sign(-b_j) * sign(|tj-C|^2 - |s-C|^2)
//   = lp2_D_T0_S * feasible_T0_T2_S
// Inputs: A(_1-_3), C(_4-_6), s(_7-_9), tj(_10-_12)
// ---------------------------------------------------------------------------
extern "C" int lp2_feasible_T0_S_T2(double Ax, double Ay, double Az,
                                 double Cx, double Cy, double Cz,
                                 double sx, double sy, double sz,
                                 double tjx, double tjy, double tjz)
{
    return lp2_D_T0_S_impl::pred{}.apply(Ax,Ay,Az, Cx,Cy,Cz, sx,sy,sz, tjx,tjy,tjz)
         * lp2_feasible_T0_T2_S_impl::pred{}.apply(Cx,Cy,Cz, sx,sy,sz, tjx,tjy,tjz);
}

// ---------------------------------------------------------------------------
// lp2_feasible_S_S_T0  -- orient_sign(seed_j, seed_k, TRI0)
// sign(a_j*b_k-a_k*b_j) * sign(b_j*c_k2-c_j2*b_k)
//   a_m=(tm-s)*(B-A), b_m=(tm-s)*(C-A), c_m2=|tm-A|^2-|s-A|^2
// factor1 reuses lp2_det2_impl
// Inputs: A(_1-_3), B(_4-_6), C(_7-_9), s(_10-_12), tj(_13-_15), tk(_16-_18)
// ---------------------------------------------------------------------------
namespace lp2_feasible_S_S_T0_factor2_impl {
    constexpr auto Ax  = grp::_1;
    constexpr auto Ay  = grp::_2;
    constexpr auto Az  = grp::_3;
    // _4 _5 _6 = B, unused
...
extern "C" int lp2_feasible_S_S_T0(double Ax, double Ay, double Az,
                                double Bx, double By, double Bz,
                                double Cx, double Cy, double Cz,
                                double sx, double sy, double sz,
                                double tjx, double tjy, double tjz,
                                double tkx, double tky, double tkz)
{
    return lp2_det2_impl::pred{}.apply(Ax,Ay,Az, Bx,By,Bz, Cx,Cy,Cz,
                                      sx,sy,sz, tjx,tjy,tjz, tkx,tky,tkz)
         * lp2_feasible_S_S_T0_factor2_impl::pred{}.apply(Ax,Ay,Az, Bx,By,Bz, Cx,Cy,Cz,
                                                       sx,sy,sz, tjx,tjy,tjz, tkx,tky,tkz);
}


// ---------------------------------------------------------------------------
// lp2_feasible_S_S_T2  -- orient_sign(seed_j, seed_k, TRI2)
// sign(a_j*b_k-a_k*b_j) * sign(c_j2*b_k-b_j*c_k2+a_j*c_k2-c_j2*a_k-2*a_j*b_k+2*b_j*a_k)
//   a_m=(tm-s)*(B-A), b_m=(tm-s)*(C-A), c_m2=|tm-A|^2-|s-A|^2
// factor1 reuses lp2_det2_impl
// Inputs: A(_1-_3), B(_4-_6), C(_7-_9), s(_10-_12), tj(_13-_15), tk(_16-_18)
// ---------------------------------------------------------------------------
namespace lp2_feasible_S_S_T2_factor2_impl {
    constexpr auto Ax  = grp::_1;
    constexpr auto Ay  = grp::_2;
    constexpr auto Az  = grp::_3;
    constexpr auto Bx  = grp::_4;
...
extern "C" int lp2_feasible_S_S_T2(double Ax, double Ay, double Az,
                                double Bx, double By, double Bz,
                                double Cx, double Cy, double Cz,
                                double sx, double sy, double sz,
                                double tjx, double tjy, double tjz,
                                double tkx, double tky, double tkz)
{
    return lp2_det2_impl::pred{}.apply(Ax,Ay,Az, Bx,By,Bz, Cx,Cy,Cz,
                                      sx,sy,sz, tjx,tjy,tjz, tkx,tky,tkz)
         * lp2_feasible_S_S_T2_factor2_impl::pred{}.apply(Ax,Ay,Az, Bx,By,Bz, Cx,Cy,Cz,
                                                       sx,sy,sz, tjx,tjy,tjz, tkx,tky,tkz);
}


// ---------------------------------------------------------------------------
// lp2_feasible_S_S_T1  -- orient_sign(seed_j, seed_k, TRI1)
// sign(a_j*b_k-a_k*b_j) * sign(c_j2*a_k-a_j*c_k2)
//   a_m=(tm-s)*(B-A), c_m2=|tm-A|^2-|s-A|^2
// factor1 reuses lp2_det2_impl
// Inputs: A(_1-_3), B(_4-_6), C(_7-_9, unused), s(_10-_12), tj(_13-_15), tk(_16-_18)
// ---------------------------------------------------------------------------
namespace lp2_feasible_S_S_T1_factor2_impl {
    constexpr auto Ax  = grp::_1;
    constexpr auto Ay  = grp::_2;
    constexpr auto Az  = grp::_3;
    constexpr auto Bx  = grp::_4;
...
extern "C" int lp2_feasible_S_S_T1(double Ax, double Ay, double Az,
                                double Bx, double By, double Bz,
                                double Cx, double Cy, double Cz,
                                double sx, double sy, double sz,
                                double tjx, double tjy, double tjz,
                                double tkx, double tky, double tkz)
{
    return lp2_det2_impl::pred{}.apply(Ax,Ay,Az, Bx,By,Bz, Cx,Cy,Cz,
                                      sx,sy,sz, tjx,tjy,tjz, tkx,tky,tkz)
         * lp2_feasible_S_S_T1_factor2_impl::pred{}.apply(Ax,Ay,Az, Bx,By,Bz, Cx,Cy,Cz,
                                                       sx,sy,sz, tjx,tjy,tjz, tkx,tky,tkz);
}


// ---------------------------------------------------------------------------
// lp2_feasible_T1_S_T2  -- orient_sign(TRI1, seed_j, TRI2)
// -lp2_D_T1_S * feasible_T1_T2_S
//   = -sign(a_j) * sign(|tj-B|^2 - |s-B|^2)
// Inputs: A(_1-_3), B(_4-_6), s(_7-_9), tj(_10-_12)
// ---------------------------------------------------------------------------
extern "C" int lp2_feasible_T1_S_T2(double Ax, double Ay, double Az,
                                 double Bx, double By, double Bz,
                                 double sx, double sy, double sz,
                                 double tjx, double tjy, double tjz)
{
    return -lp2_D_T1_S_impl::pred{}.apply(Ax,Ay,Az, Bx,By,Bz, sx,sy,sz, tjx,tjy,tjz)
         *  lp2_feasible_T1_T2_S_impl::pred{}.apply(Bx,By,Bz, sx,sy,sz, tjx,tjy,tjz);
}


// ---------------------------------------------------------------------------
// lp2_feasible_T2_S_T1  -- orient_sign(TRI2, seed_j, TRI1)
// lp2_D_T2_S * feasible_T1_T2_S
//   = sign(b_j - a_j) * sign(|tj-B|^2 - |s-B|^2)
// Inputs: B(_1-_3), C(_4-_6), s(_7-_9), tj(_10-_12)
// ---------------------------------------------------------------------------
extern "C" int lp2_feasible_T2_S_T1(double Bx, double By, double Bz,
                                 double Cx, double Cy, double Cz,
                                 double sx, double sy, double sz,
                                 double tjx, double tjy, double tjz)
{
    return lp2_D_T2_S_impl::pred{}.apply(Bx,By,Bz, Cx,Cy,Cz, sx,sy,sz, tjx,tjy,tjz)
         * lp2_feasible_T1_T2_S_impl::pred{}.apply(Bx,By,Bz, sx,sy,sz, tjx,tjy,tjz);
}


// ---------------------------------------------------------------------------
// lp2_feasible_T2_S_T0  -- orient_sign(TRI2, seed_j, TRI0)
// -lp2_D_T2_S * feasible_T0_T2_S
//   = -sign(b_j - a_j) * sign(|tj-C|^2 - |s-C|^2)
// Inputs: B(_1-_3), C(_4-_6), s(_7-_9), tj(_10-_12)
// ---------------------------------------------------------------------------
extern "C" int lp2_feasible_T2_S_T0(double Bx, double By, double Bz,
                                 double Cx, double Cy, double Cz,
                                 double sx, double sy, double sz,
                                 double tjx, double tjy, double tjz)
{
...
// ---------------------------------------------------------------------------
// lp2_feasible_T0_S_T1  -- orient_sign(TRI0, seed_j, TRI1)
// -lp2_D_T0_S * feasible_T0_T1_S
//   = -sign(-b_j) * sign(|tj-A|^2 - |s-A|^2)
// Inputs: A(_1-_3), C(_4-_6), s(_7-_9), tj(_10-_12)
// ---------------------------------------------------------------------------
extern "C" int lp2_feasible_T0_S_T1(double Ax, double Ay, double Az,
                                 double Cx, double Cy, double Cz,
                                 double sx, double sy, double sz,
                                 double tjx, double tjy, double tjz)
{
    return -lp2_D_T0_S_impl::pred{}.apply(Ax,Ay,Az, Cx,Cy,Cz, sx,sy,sz, tjx,tjy,tjz)
         *  lp2_feasible_T0_T1_S_impl::pred{}.apply(Ax,Ay,Az, sx,sy,sz, tjx,tjy,tjz);
}


// ---------------------------------------------------------------------------
// lp2_feasible_T1_S_T0  -- orient_sign(TRI1, seed_j, TRI0)
// lp2_D_T1_S * feasible_T0_T1_S
//   = sign(a_j) * sign(|tj-A|^2 - |s-A|^2)
// Inputs: A(_1-_3), B(_4-_6), s(_7-_9), tj(_10-_12)
// ---------------------------------------------------------------------------
extern "C" int lp2_feasible_T1_S_T0(double Ax, double Ay, double Az,
                                 double Bx, double By, double Bz,
                                 double sx, double sy, double sz,
                                 double tjx, double tjy, double tjz)
{
...
using _size_lp2_feasible_T0_T1_S = show_stage_d_size<lp2_feasible_T0_T1_S_impl::exact::results_size>*;
using _size_lp2_feasible_T1_T2_S = show_stage_d_size<lp2_feasible_T1_T2_S_impl::exact::results_size>*;
using _size_lp2_feasible_T0_T2_S = show_stage_d_size<lp2_feasible_T0_T2_S_impl::exact::results_size>*;
using _size_lp2_D_T0_S     = show_stage_d_size<lp2_D_T0_S_impl::exact::results_size>*;
using _size_lp2_D_T1_S     = show_stage_d_size<lp2_D_T1_S_impl::exact::results_size>*;
using _size_lp2_D_T2_S     = show_stage_d_size<lp2_D_T2_S_impl::exact::results_size>*;
using _size_lp2_det2       = show_stage_d_size<lp2_det2_impl::exact::results_size>*;
using _size_lp2_feasible_T0_S_S_f1 = show_stage_d_size<lp2_feasible_T0_S_S_factor1_impl::exact::results_size>*;
using _size_lp2_feasible_T0_S_S_f2 = show_stage_d_size<lp2_feasible_T0_S_S_factor2_impl::exact::results_size>*;
using _size_lp2_feasible_T1_S_S_f1 = show_stage_d_size<lp2_feasible_T1_S_S_factor1_impl::exact::results_size>*;
using _size_lp2_feasible_T1_S_S_f2 = show_stage_d_size<lp2_feasible_T1_S_S_factor2_impl::exact::results_size>*;
using _size_lp2_feasible_T2_S_S_f1 = show_stage_d_size<lp2_feasible_T2_S_S_factor1_impl::exact::results_size>*;
using _size_lp2_feasible_T2_S_S_f2 = show_stage_d_size<lp2_feasible_T2_S_S_factor2_impl::exact::results_size>*;
using _size_lp2_det3       = show_stage_d_size<lp2_det3_impl::exact::results_size>*;
