...
inline implicitPoint3D_LNC::implicitPoint3D_LNC(const s_dynarray *_registry, int _p_id, int _q_id,
	const double _t)
	: genericPoint(Point_Type::LNC), registry(_registry), ip_id(_p_id), iq_id(_q_id), t(_t)
{
